...
class JigsawUtils {
  ...
  static Future<JigsawPuzzle> sliceImageIntoPieces({
    ...
    try {
      ...
      if (numCols <= 0 || numRows <= 0) {
        throw JigsawInitializationError(
          'Invalid grid size',
          details: 'Grid dimensions must be positive numbers',
        );
      }
      ...
      if (pieceWidth <= 0 || pieceHeight <= 0) {
        throw JigsawInitializationError(
          'Invalid piece dimensions',
          details: 'Calculated piece dimensions must be positive numbers',
        );
      }
      ...
      for (int row = 0; row < numRows; row++) {
        for (int col = 0; col < numCols; col++) {
          ...
          try {
            ...
            throw JigsawInitializationError(
              'Failed to create puzzle piece',
              details: 'Error occurred while creating piece at position ($row, $col)',
              originalError: e,
            );
          }
        }
      ...
      throw JigsawInitializationError(
        ...
        details: 'An unexpected error occurred while creating the puzzle',
        originalError: e,
      );
    }
  }
  ...
  static bool shouldSnap({
    ...
    try {
      ...
      throw JigsawPieceOperationError(
        'Failed to check piece snapping',
        details: 'Error occurred while checking if pieces should snap',
        originalError: e,
      );
    }
  }
  ...
  static void snapPieces(JigsawPiece piece1, JigsawPiece piece2) {
    try {
      ...
      throw JigsawPieceOperationError(
        'Failed to snap pieces',
        details: 'Error occurred while snapping pieces together',
        originalError: e,
      );
    }
  }
  ...
  static void rotatePiece(JigsawPiece piece) {
    try {
      ...
      throw JigsawPieceOperationError(
        ...
        details: 'Error occurred while rotating piece',
        originalError: e,
      );
    }
  }
